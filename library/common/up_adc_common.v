...
module up_adc_common #(
  ...
  always @(posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      if ((up_wreq_s == 1'b1) && (up_waddr[6:0] == 7'h11)) begin
        up_adc_sdr_ddr_n <= up_wdata[6];
        up_adc_single_lane <= up_wdata[5];
    ...
    if (up_rstn == 0) begin
      ...
      if (up_rreq_s == 1'b1) begin
        case (up_raddr[6:0])
          ...
          7'h11: up_rdata_int <= {25'd0, up_adc_sdr_ddr_n, up_adc_single_lane,
                                  up_adc_sref_sync, up_adc_sync, up_adc_r1_mode,
  ...
  up_xfer_cntrl #(.DATA_WIDTH(40)) i_xfer_cntrl (
    .up_rstn (up_rstn),
    .up_clk (up_clk),
