...
module up_axi #(
  ...
  assign up_rack_s = (up_rcount == 6'h3f) ? 1'b1 : (up_rcount[5] & up_rack);
  assign up_rdata_s = (up_rcount == 6'h3f) ? {2{16'hdead}} : up_rdata;
  ...
  always @(posedge up_clk) begin
    if (up_rstn == 1'b0) begin
      ...
      if (up_rack_s == 1'b1) begin
        up_rcount <= 6'h00;
      end else if (up_rcount[5] == 1'b1) begin
