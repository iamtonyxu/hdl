...
set_property  -dict {PACKAGE_PIN  AK30  IOSTANDARD LVCMOS25  PULLTYPE PULLUP} [get_ports spi_clk]                          ; ## D27  FMC_LPC_LA26_N
...
create_clock -name rx_clk       -period  4.00 [get_ports rx_clk_in]
